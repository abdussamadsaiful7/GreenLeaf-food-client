            ...
            <div className='print'>
                <div className='sss'>
                    <div ref={ref} className='a'>
                        <div className='mb-10'>
                            <div className='bg-gray-200 md:mx-28 md:py-2 mt-4'>
                                <h1 className='text-center my-8 text-3xl font-semibold  md:p-8 bg-white py-4 mb-2 md:mx-28 shadow-md '>Theory of Documentation 📝</h1>
                            </div>
                            <div className='bg-gray-200 lg:py-8 lg:mx-28 mt-4'>
                                <div className='md:mx-14 mx-8 my-4 bg-white shadow-md p-8 '>
